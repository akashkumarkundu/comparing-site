...
6. DYNAMICALLY GENERATE 10 TO 12 COMPREHENSIVE COMPARISON CRITERIA covering the core defining dimensions of the items:
   - Focus strictly on the MAIN, SUBSTANTIVE, HIGH-VALUE TERMINOLOGIES and decisive metrics:
     ...
     * For Products/Tech: Price / Value, Processor / CPU, RAM / Memory, Storage / Capacity, Display / Screen, Battery Life, Graphics / GPU, Build Quality / Materials, Connectivity / Ports, Operating System, Warranty / Support.
   ...
   - FACT EXTRACTION THOROUGHNESS: Thoroughly read ALL sections of the provided page text (including [SUMMARY & LEAD OVERVIEW], [KEY FINANCIALS, WEALTH & PRICING], [SPECIFICATIONS & ATTRIBUTES], and [ADDITIONAL DETAILS]). If a metric like Net Worth, Price, or Features is mentioned anywhere in the text (e.g. 'Forbes estimates his net worth to be US$908 billion', 'net worth stood at US$106.5 billion'), extract that stated value accurately into the table!
